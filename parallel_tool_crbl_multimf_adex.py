...
def init(parameter_simulation,parameter_model,parameter_connection_between_region,parameter_coupling,
    ...
    if parameter_model['robi']:
        import tvb_model_reference.src.parallel_crbl_multimf_adex as model
        ...
        if parameter_model['order'] == 1:
            ...
            model.T_adex = np.array(parameter_model['T_adex'])
            ...
            ## Taken from Adex mìbut also in only cerebellum config
