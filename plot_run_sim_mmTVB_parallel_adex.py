...
## Import tools:
from tools_for_plot_mmTVB_parallel_adex import *
import os
import argparse

"""
Needed a new tool for plot because I have to do *1e3 at the FR of cerebral cortex too!!! And I want to plot the Adaptation current
"""
...
def main():
    ...
    parser.add_argument("root_path", help="Root path of the machine")
    parser.add_argument("--prot_folder", help="Protocol folder", default='HCP_TVBmm_30M')
    ...
    folder_root = args.root_path
    prot_dirname = args.prot_folder
    sub_id = args.SUB_ID
    tvb_out_dirname = args.tvb_out_dirname

    sub_tvb_outfolder = os.path.join(folder_root, prot_dirname, sub_id, tvb_out_dirname)
