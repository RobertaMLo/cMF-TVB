...
class Parameter :
    def __init__(self):
        ...
        self.parameter_model ={
            ...
            'tau_OU': 3.5,
            'weight_noise': 4e-3, # #  4KHZ consistent with Lorenzi et al 2023
            
            #'K_ext_e': 400, #Kmf_grc
            #'K_ext_i':0,
    
      
            #parameter of WW model
            'a_e': 310.,
            'b_e':125.,
            'd_e':0.160,
            'gamma_e':0.641/1000,
            ...
            'initial_condition':{
                 # Left at 0 GrC and GoC because they correspond to Se and Si in cortex/DCN; while MLI and PC set at the proper CI
                "d1": [0.5, 0.5*1e-3],"d2": [4.0, 4.0*1e-3], "d3": [15*1e-3, 15*1e-3], "d4": [30*1e-3, 30*1e-3], "noise":[0.0*1e-3, 0.0*1e-3]} 
        }
